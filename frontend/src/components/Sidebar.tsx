...
const adminNav = [
  ...
  { key: 'admin-classes', label: 'Subjects & Classes', icon: 'classes' },
  { key: 'admin-settings', label: 'Settings', icon: 'settings' },
  { key: 'admin-profile', label: 'My Profile', icon: 'users' },
]

const teacherNav = [
  { key: 'teacher-dashboard', label: 'Dashboard', icon: 'dashboard' },
  { key: 'teacher-quizzes', label: 'Quizzes', icon: 'quiz' },
  { key: 'teacher-question-bank', label: 'Question bank', icon: 'quiz' },
  { key: 'teacher-classes', label: 'Classes & Students', icon: 'classes' },
  ...
  { key: 'teacher-profile', label: 'My Profile', icon: 'users' },
]

const studentNav = [
  { key: 'student-dashboard', label: 'Dashboard', icon: 'dashboard' },
  { key: 'student-subjects', label: 'My Subjects', icon: 'subjects' },
  { key: 'student-training', label: 'Training', icon: 'quiz' },
  { key: 'student-join', label: 'Join Live Quiz', icon: 'live' },
  { key: 'student-history', label: 'History', icon: 'stats' },
  { key: 'student-profile', label: 'Profile', icon: 'settings' },
]
