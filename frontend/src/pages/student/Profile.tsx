    ...
    <div style={{ padding: '20px 16px 84px', background: '#F8FAFC', minHeight: '100vh' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: 24 }}>
        <div style={{ position: 'relative', width: 90, height: 90, margin: '0 auto 12px' }}>
          <div style={{ width: 90, height: 90, borderRadius: '50%', background: `${color}20`, border: `4px solid ${color}`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 44 }}>
            {emoji}
          </div>
        ...
        <p style={{ fontSize: 14, color: '#64748B', margin: 0 }}>Student {user?.email ? `· ${user.email}` : ''}</p>
